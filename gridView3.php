                  ...
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-2 pe-xl-4">
                    ...
                    <li class="nav-item my-2 dropdown dropstart">
                      ...
                      <ul class="dropdown-menu" id="dropdown-menu">
                        <li><a class="dropdown-item" href="gridView.php">Grid view</a></li>
...
<div class="container-fluid my-4">
    <div class="row d-flex justify-content-center" id="targetContainer">
    ...
    $.ajax({
        ...
        success: function(response) {
            if (Array.isArray(response)) {
                  ...
                  if(role.checkbox.includes('dash-board') && role.dash_board === 'read-only'){
                    return machineList.map(function(machine) {
                      console.log(machine)
                        ...
                        return ` <div class="col-6 col-md-3 col-lg-2 mb-4 d-flex justify-content-center">
                            <div id="${machine.machine_id}" onclick="updatebutton(${machine.machine_id})" style="background-color:${machine.fiill_color}" class="rounded-4 d-flex align-items-center justify-content-center productionBox">
                                <p class="disableCur gridViewText">${machine.machine_name}</p>
                            </div>
                        </div>
                          `;
                    }).join('');}
                ...
                let machineHTML = generateMachineHTML(machines);
                document.getElementById("targetContainer").innerHTML = machineHTML;
...
const socket = new WebSocket('ws://192.168.38.102:8080');
